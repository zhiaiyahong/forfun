...
public abstract class CryptoHandler {
   ...
   public abstract String encrypt(String input,String secretKey);
    ...
    public String crypto(boolean doEncrypt,boolean doDecrypt,Object inputObject,boolean strict,String secretKey){
        try {
            if(inputObject == null){
                return null;
            }
            String input = String.valueOf(inputObject);
            ...
            log.error("执行出现错误,p=doEncrypt:{},doDecrypt:{},strict:{},input:{},e=",doEncrypt,doDecrypt,strict,inputObject,e);
            if(strict){
                throw new RuntimeException(e);
            }
        }
        return String.valueOf(inputObject);
    }
}
