...
import com.yhwch.annotation.Crypto;
import com.yhwch.annotation.handler.CryptoHandler;
import com.yhwch.annotation.util.ReflectionUtil;
...
public class CryptoAspect {
    ...
    @Pointcut("@annotation(com.yhwch.annotation.Crypto)")
            ...
            if(!ReflectionUtil.isPOJO(object) && isContains(cryptoList,parameterNames[i])){
                ...
                for (Field field : object.getClass().getDeclaredFields()) {
                    ...
                    if (isDoCrypto(cryptoList,field)) {
                        field.set(object,cryptoHandler.crypto(crypto.encrypt(),crypto.decrypt(),field.get(object),crypto.strict(),crypto.secretKey()));
                    }
                }
            }
        }
